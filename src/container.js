...
function createContainer(options = {}) {
  ...
  const contextBuilder = new ContextBuilder({ config, stateService, planService, mealRepository, weightRepository, memoryRepository, reminderRepository, conversationRepository, pendingInteractionRepository });
